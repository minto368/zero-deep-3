...
from leopard.utils import pair
...
class RNN(Layer):
    def __init__(self, hidden_size, in_size=None):
        ...
        """
        super().__init__()
        # バイアスは一つだけなので、self.h2hのバイアスを無しにする。
        self.x2h = Linear(hidden_size, in_size=in_size)  # input2hidden
        self.h2h = Linear(hidden_size, in_size=in_size, nobias=True)  # hidden2hidden
        self.h = None
